...
public class LCRGetByCheckURLTest {
	...
	public static void main(String[] args) throws Exception {
		...
		ClientResponse clientResponse = webResource.path("check/{url}").queryParams(params).accept(MediaType.APPLICATION_JSON).get(ClientResponse.class);
